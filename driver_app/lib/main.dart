...
Future<void> _setupFcm() async {
  ...
  debugPrint('FCM token (driver): $token');
  ...
  messaging.onTokenRefresh.listen((newToken) {
    debugPrint('FCM token refreshed (driver): $newToken');
  });
}
...
void main() async {
  ...
  runApp(const ProviderScope(child: WeditDriverApp()));
}

class WeditDriverApp extends ConsumerWidget {
  const WeditDriverApp({super.key});
